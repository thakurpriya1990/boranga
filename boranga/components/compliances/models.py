...
from boranga.components.main.models import CommunicationsLogEntry, UserAction, Document, RevisionedMixin
...
class Compliance(RevisionedMixin):
    ...
    proposal = models.ForeignKey('boranga.Proposal',related_name='compliances', on_delete=models.CASCADE)
    approval = models.ForeignKey('boranga.Approval',related_name='compliances', on_delete=models.CASCADE)
    ...
    #assigned_to = models.ForeignKey(EmailUser,related_name='boranga_compliance_assignments',null=True,blank=True, on_delete=models.SET_NULL)
    ...
    #submitter = models.ForeignKey(EmailUser, blank=True, null=True, related_name='boranga_compliances', on_delete=models.SET_NULL)

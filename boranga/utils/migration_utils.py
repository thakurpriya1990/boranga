...
from boranga.components.main.models import ApplicationType, Park
from boranga.components.proposals.models import Proposal, ProposalType, ProposalOtherDetails, ProposalPark
from boranga.components.approvals.models import Approval
from boranga.components.bookings.models import ApplicationFee, ParkBooking, Booking
...
def run_deploy(tclass_csv, eclass_csv):
    ...
    eclass_csv: 'boranga/utils/csv/E-Class-20191119.csv'
    """
    clear_applications()
...
def clear_applications():
    def reset_sql_idx():
        ...
        cursor.execute('''ALTER SEQUENCE boranga_applicationfee_id_seq RESTART WITH 1''')
        cursor.execute('''ALTER SEQUENCE boranga_parkbooking_id_seq RESTART WITH 1''')
        cursor.execute('''ALTER SEQUENCE boranga_booking_id_seq RESTART WITH 1''')
        cursor.execute('''ALTER SEQUENCE boranga_approval_id_seq RESTART WITH 1''')
        cursor.execute('''ALTER SEQUENCE boranga_proposal_id_seq RESTART WITH 1''')
...
class OrganisationReader():
    ...
    Usage:
        from boranga.utils.migration_utils import OrganisationReader
...
#                data.update({'start_date': datetime.date.today()})
        ...
        try:
            ...
            To test:
                from boranga.components.proposals.models import create_organisation_data
                create_migration_data('boranga/utils/csv/orgs.csv')
            '''

...
from boranga.components.approvals.models import Approval, ApprovalUserAction
from boranga.components.proposals.models import Proposal, ProposalUserAction

...
router.register(r'threat_categories', species_communities_api.ThreatCategoryViewSet)
router.register(r'current_impact', species_communities_api.CurrentImpactViewSet)
router.register(r'potential_impact', species_communities_api.PotentialImpactViewSet)
router.register(r'potential_threat_onset', species_communities_api.PotentialThreatOnsetViewSet)

# Generated by Django 3.2.12 on 2022-02-22 03:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(default='None', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='districts', to='boranga.regiondistrict')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('district', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='species_district', to='boranga.regiondistrict')),
                ('group_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='boranga.grouptype')),
                ('region', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='species_region', to='boranga.regiondistrict')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(default='None', max_length=512)),
                ('source', models.CharField(default='None', max_length=1024)),
                ('district', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='conservation_plan_district', to='boranga.regiondistrict')),
                ('region', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='conservation_plan_region', to='boranga.regiondistrict')),
                ('species', models.ManyToManyField(to='boranga.Species')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('district', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='community_district', to='boranga.regiondistrict')),
                ('group_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='boranga.grouptype')),
                ('region', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='community_region', to='boranga.regiondistrict')),
                ('species', models.ManyToManyField(to='boranga.Species')),
            ],
        ),
        migrations.CreateModel(

    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Related Items <small></small>
                ...
                <div class="" >                        
                    <div class="form-horizontal col-sm-12 borderDecoration">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-3">
                                    <label class="control-label pull-left"  for="Name">Some related items data</label>
                                </div>
                                <div class="col-sm-9" style="margin-bottom: 5px; width:53% !important">
                                    <input type="text" class="form-control" name="Some species data" placeholder="" :disabled="proposal.readonly" v-model="some_related_items_data">
                                </div>
                            </div>
                        </div> 
                    </div>

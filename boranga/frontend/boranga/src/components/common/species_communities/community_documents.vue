<template lang="html">
    <div id="community_documents">
        ...
        <DocumentDetail ref="document_detail" @refreshFromResponse="refreshFromResponse" :url="community_document_url"
            :is_internal="is_internal"></DocumentDetail>
        <div v-if="communityDocumentHistoryId">
            <CommunityDocumentHistory ref="community_document_history" :key="communityDocumentHistoryId"
                :document-id="communityDocumentHistoryId" :community-id="species_community.id" />
        </div>
    </div>
</template>
<script>
...
export default {
    ...
    methods: {
        ...
        editDocument: function (id) {
            ...
            fetch(helpers.add_endpoint_json(api_endpoints.community_documents, id)).then(async (response) => {
        ...
        discardDocument: function (id) {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch(helpers.add_endpoint_json(api_endpoints.community_documents, id + '/discard'), {
                        method: 'PATCH',
        ...
        reinstateDocument: function (id) {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch(helpers.add_endpoint_json(api_endpoints.community_documents, id + '/reinstate'), {
                        method: 'PATCH',
                        headers: { 'Content-Type': 'application/json', }
                    })
                        .then((response) => {

<template lang="html">
    <div id="species_documents">
        <FormSection :formCollapse="false" label="Documents" :Index="documentBody">
            ...
            <form class="form-horizontal" action="index.html" method="post">
                <div v-if="!is_readonly" class="col-sm-12">
                    <div class="text-end">
                        <button :disabled="is_readonly" type="button" class="btn btn-primary mb-2 "
        ...
        <DocumentDetail ref="document_detail" @refreshFromResponse="refreshFromResponse" :url="species_document_url"
            :is_internal="is_internal"></DocumentDetail>
        <div v-if="speciesDocumentHistoryId">
            <SpeciesDocumentHistory ref="species_document_history" :key="speciesDocumentHistoryId"
                :document-id="speciesDocumentHistoryId" :species-id="species_community.id" />
        </div>
    </div>
</template>
<script>

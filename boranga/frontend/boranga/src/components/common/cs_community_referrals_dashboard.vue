<template id="cs_communities_referrals_dashboard">
    <div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select id="cs_ref_community_id_lookup" name="cs_ref_community_id_lookup"
                            ref="cs_ref_community_id_lookup" class="form-control" />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="cs_ref_community_name_lookup">Community Name:</label>
                        <select id="cs_ref_community_name_lookup" name="cs_ref_community_name_lookup"
                            ref="cs_ref_community_name_lookup" class="form-control" />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
        ...
        <div class="row">
            <div class="col-lg-12">
                <datatable ref="cs_communities_ref_datatable" :id="datatable_id" :dtOptions="datatable_options"
...
export default {
    ...
    methods: {
        ...
        addEventListeners: function () {
            let vm = this;
            vm.$refs.cs_communities_ref_datatable.vmDataTable.on('childRow.dt', function (e, settings) {
                helpers.enablePopovers();
            });
        },
    },

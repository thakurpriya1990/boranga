<template id="species_flora_dashboard">
    <div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select id="scientific_name_lookup" name="scientific_name_lookup" ref="scientific_name_lookup"
                            class="form-control" />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select id="common_name_lookup" name="common_name_lookup" ref="common_name_lookup"
                            class="form-control" />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select id="phylo_group_lookup" name="phylo_group_lookup" ref="phylo_group_lookup"
                            class="form-control" />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select id="family_lookup" name="family_lookup" ref="family_lookup" class="form-control" />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="genera_lookup">Genera:</label>
                        <select id="genera_lookup" name="genera_lookup" ref="genera_lookup" class="form-control" />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="form-select" v-model="filterFloraRegion" @change="filterDistrict($event)">
                            <option value="all">All</option>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select id="wa-legislative-list" class="form-select" v-model="filterFloraWALegislativeList">
                            <option value="all">All</option>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select id="wa-priority-category" class="form-select" v-model="filterFloraWAPriorityCategory">
                            <option value="all">All</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check form-switch mt-1">
                            <input class="form-check-input" type="checkbox" id="commonwealth-relevance"
                                v-model="filterFloraCommonwealthRelevance" true-value="true" false-value="false">
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="form-check form-switch mt-1">
                            <input class="form-check-input" type="checkbox" id="international-relevance"
                                v-model="filterFloraInternationalRelevance" true-value="true" false-value="false">
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="input" id="conservation-criteria"
                            v-model="filterFloraConsevationCriteria" placeholder="Enter text to search for">
                    </div>
                </div>
            </div>
        </CollapsibleFilters>
        ...
        <div v-if="newFloraVisibility" class="col-md-12">
            <div class="text-end">
                <button type="button" class="btn btn-primary mb-2 " @click.prevent="createFlora"><i
                        class="fa-solid fa-circle-plus"></i> New Flora </button>
            </div>
        </div>

        <div class="row">
            <div class="col-lg-12">
                <datatable ref="flora_datatable" :id="datatable_id" :dtOptions="datatable_options"
                    :dtHeaders="datatable_headers" />
            </div>
        </div>
        <div v-if="speciesHistoryId">
            <SpeciesHistory ref="species_history" :key="speciesHistoryId" :species-id="speciesHistoryId" />
        </div>
    </div>
</template>
<script>
...
export default {
    ...
    data() {
        ...
        return {
            ...
            filterFloraWALegislativeList: sessionStorage.getItem(this.filterFloraWALegislativeList_cache) ?
                sessionStorage.getItem(this.filterFloraWALegislativeList_cache) : 'all',

            filterFloraWALegislativeCategory: sessionStorage.getItem(this.filterFloraWALegislativeCategory_cache) ?
                sessionStorage.getItem(this.filterFloraWALegislativeCategory_cache) : 'all',

            filterFloraWAPriorityCategory: sessionStorage.getItem(this.filterFloraWAPriorityCategory_cache) ?
                sessionStorage.getItem(this.filterFloraWAPriorityCategory_cache) : 'all',

            filterFloraCommonwealthRelevance: sessionStorage.getItem(this.filterFloraCommonwealthRelevance_cache) ?
                sessionStorage.getItem(this.filterFloraCommonwealthRelevance_cache) : "false",

            filterFloraInternationalRelevance: sessionStorage.getItem(this.filterFloraInternationalRelevance_cache) ?
                sessionStorage.getItem(this.filterFloraInternationalRelevance_cache) : "false",

            filterFloraConsevationCriteria: sessionStorage.getItem(this.filterFloraConsevationCriteria_cache) ?
                sessionStorage.getItem(this.filterFloraConsevationCriteria_cache) : "",
    ...
    watch: {
        ...
        filterFloraWALegislativeList: function () {
            let vm = this;
            vm.$refs.flora_datatable.vmDataTable.ajax.reload(helpers.enablePopovers, false); // This calls ajax() backend call.
            sessionStorage.setItem(vm.filterFloraWALegislativeList_cache, vm.filterFloraWALegislativeList);
        },
        filterFloraWALegislativeCategory: function () {
            let vm = this;
            vm.$refs.flora_datatable.vmDataTable.ajax.reload(helpers.enablePopovers, false); // This calls ajax() backend call.
            sessionStorage.setItem(vm.filterFloraWALegislativeCategory_cache, vm.filterFloraWALegislativeCategory);
        },
        filterFloraWAPriorityCategory: function () {
            let vm = this;
            vm.$refs.flora_datatable.vmDataTable.ajax.reload(helpers.enablePopovers, false); // This calls ajax() backend call.
            sessionStorage.setItem(vm.filterFloraWAPriorityCategory_cache, vm.filterFloraWAPriorityCategory);
        },
        filterFloraCommonwealthRelevance: function () {
            let vm = this;
            vm.$refs.flora_datatable.vmDataTable.ajax.reload(helpers.enablePopovers, false); // This calls ajax() backend call.
            sessionStorage.setItem(vm.filterFloraCommonwealthRelevance_cache, vm.filterFloraCommonwealthRelevance);
        },
        filterFloraInternationalRelevance: function () {
            let vm = this;
            vm.$refs.flora_datatable.vmDataTable.ajax.reload(helpers.enablePopovers, false); // This calls ajax() backend call.
            sessionStorage.setItem(vm.filterFloraInternationalRelevance_cache, vm.filterFloraInternationalRelevance);
        },
        filterFloraConsevationCriteria: function () {
            let vm = this;
            vm.$refs.flora_datatable.vmDataTable.ajax.reload(helpers.enablePopovers, false); // This calls ajax() backend call.
            sessionStorage.setItem(vm.filterFloraConsevationCriteria_cache, vm.filterFloraConsevationCriteria);
        },
            ...
            return {
                ...
                ajax: {
                    ...
                    "data": function (d) {
                        ...
                        d.filter_wa_legislative_list = vm.filterFloraWALegislativeList;
                        d.filter_wa_legislative_category = vm.filterFloraWALegislativeCategory;
                        d.filter_wa_priority_category = vm.filterFloraWAPriorityCategory;
                        d.filter_commonwealth_relevance = vm.filterFloraCommonwealthRelevance;
                        d.filter_international_relevance = vm.filterFloraInternationalRelevance;
                        d.filter_conservation_criteria = vm.filterFloraConsevationCriteria;

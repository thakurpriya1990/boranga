<template id="species_fauna_dashboard">
    <div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="form-select" v-model="filterFaunaRegion" @change="filterDistrict($event)">
                            <option value="all">All</option>
        ...
        <div v-if="newFaunaVisibility" class="col-md-12">
            <div class="text-end">
                <button type="button" class="btn btn-primary mb-2 " @click.prevent="createFauna"><i
                        class="fa-solid fa-circle-plus"></i> New Fauna </button>
            </div>
        </div>

        <div class="row">
            <div class="col-lg-12">
                <datatable ref="fauna_datatable" :id="datatable_fauna_id" :dtOptions="datatable_options"
...
export default {
    ...
    methods: {
        ...
        addEventListeners: function () {
            ...
            vm.$refs.fauna_datatable.vmDataTable.on('click', 'a[data-reinstate-species-proposal]', function (e) {
                e.preventDefault();

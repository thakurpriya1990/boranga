    ...
    computed: {
        ...
        column_action: function () {
            return {
                ...
                'render': function (data, type, full) {
                    let links = '';
                    links += full.can_be_processed ? `<a href='/external/conservation_status/${full.conservation_status_id}/referral/${full.id}'>Process</a><br/>` : `<a href='/internal/conservation_status/${full.conservation_status_id}/referral/${full.id}'>View</a><br/>`;
                    return links;
                },
            }
        },

    ...
    computed: {
        ...
        column_action: function () {
            return {
                ...
                'render': function (data, type, full) {
                    let links = "";
                    links += full.can_be_processed ? `<a href='/internal/occurrence-report/${full.occurrence_report_id}/referral/${full.id}'>Process</a><br/>` : `<a href='/internal/occurrence-report/${full.occurrence_report_id}/referral/${full.id}'>View</a><br/>`;
                    return links;
                },
            }
        },

<template lang="html">
    <div :id="'related_ocr' + section_type">
        <FormSection :formCollapse="false" label="Related Occurrence Reports" :Index="'related_ocr' + section_type"
            @toggle-collapse="toggleCollapse">
            <div>
                <datatable ref="related_ocr_datatable" :id="datatable_id" :dtOptions="datatable_options"
                    :dtHeaders="datatable_headers" />
            </div>
        </FormSection>

        <div v-if="sectionOCRId">
            <SectionModal ref="section_modal" :key="sectionOCRId" :sectionTypeDisplay="sectionTypeFormatted"
                :sectionType="section_type" :ocrNumber="sectionOCRId" :sectionObj="sectionObj" />
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        viewSection: function (id) {
            ...
            fetch(helpers.add_endpoint_json(api_endpoints.occurrence_report, id)).then(async (response) => {
        ...
        copySection: function (id, merge) {
            ...
            fetch(helpers.add_endpoint_json(api_endpoints.occurrence, vm.occurrence_obj.id + "/copy_ocr_section"), {
                method: 'POST',
                body: formData,
                headers: {

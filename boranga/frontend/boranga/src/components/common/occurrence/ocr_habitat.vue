    ...
    <div id="habitat">
        <FormSection :formCollapse="false" label="Habitat Composition" :Index="habitatCompositionBody">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <select :disabled="isReadOnly" class="form-select"
                        v-model="occurrence_report_obj.habitat_composition.rock_type_id">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <select :disabled="isReadOnly" class="form-select"
                        v-model="occurrence_report_obj.habitat_composition.soil_colour_id">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <select :disabled="isReadOnly" class="form-select"
                        v-model="occurrence_report_obj.habitat_composition.drainage_id">
        ...
        <FormSection :formCollapse="false" label="Fire History" :Index="fireHistoryBody">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <select :disabled="isReadOnly" class="form-select"
                        v-model="occurrence_report_obj.fire_history.intensity_id">

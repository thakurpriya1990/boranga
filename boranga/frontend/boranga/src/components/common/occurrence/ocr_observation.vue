        ...
        <FormSection :formCollapse="false" label="Identification" :Index="identificationBody">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <template v-if="!isReadOnly">
                        <template
                            v-if="identification_certainty_list && identification_certainty_list.length > 0 && occurrence_report_obj.identification.identification_certainty_id && !identification_certainty_list.map((d) => d.id).includes(occurrence_report_obj.identification.identification_certainty_id)">
                            <input type="text" v-if="occurrence_report_obj.identification.identification_certainty"
                                class="form-control mb-3"
                                :value="occurrence_report_obj.identification.identification_certainty + ' (Now Archived)'" disabled />
                            <div class="mb-3 text-muted">
                                Change identification certainty to:
                            </div>
                        </template>
                        <select class="form-select" v-model="occurrence_report_obj.identification.identification_certainty_id">
                    ...
                    <template v-else>
                        <input class="form-control" type="text" :disabled="isReadOnly"
                            v-model="occurrence_report_obj.identification.identification_certainty" />
                    </template>
                </div>
            </div>
            <div class="row mb-3">

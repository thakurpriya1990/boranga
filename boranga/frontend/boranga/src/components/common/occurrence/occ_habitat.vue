        ...
        <FormSection :formCollapse="false" label="Habitat Condition" :Index="habitatConditionBody">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    ...
                    v-model="occurrence_obj.habitat_condition.pristine" @change.prevent="calcKeiryTotal()"/>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    ...
                    v-model="occurrence_obj.habitat_condition.excellent" @change.prevent="calcKeiryTotal()"/>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    ...
                    v-model="occurrence_obj.habitat_condition.very_good" @change.prevent="calcKeiryTotal()"/>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    ...
                    v-model="occurrence_obj.habitat_condition.good" @change.prevent="calcKeiryTotal()"/>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    ...
                    v-model="occurrence_obj.habitat_condition.degraded" @change.prevent="calcKeiryTotal()"/>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    ...
                    v-model="occurrence_obj.habitat_condition.completely_degraded" @change.prevent="calcKeiryTotal()"/>
                </div>
            </div>
            <div class="row mb-3">
        ...
        <FormSection :formCollapse="false" label="Associated Species" :Index="associatedSpeciesBody">
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <RichText
                        id="related_species"
                        :proposalData="occurrence_obj.associated_species.related_species"
                        ref="related_species"

...
export default {
    ...
    methods: {
        ...
        editDocument: function (id) {
            ...
            fetch(helpers.add_endpoint_json(api_endpoints.occurrence_report_documents, id)).then(async (response) => {
        ...
        discardDocument: function (id) {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch(helpers.add_endpoint_json(api_endpoints.occurrence_report_documents, id + '/discard'), {
                        method: 'PATCH',
        ...
        reinstateDocument: function (id) {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch(helpers.add_endpoint_json(api_endpoints.occurrence_report_documents, id + '/reinstate'), {
                        method: 'PATCH',
                        headers: { 'Content-Type': 'application/json', }
                    })
                        .then((response) => {

...
<template lang="html">
    <div id="ocr_threats">
        ...
        <ThreatDetail ref="threat_detail" @refreshFromResponse="refreshFromResponse" :url="ocr_threat_url">
        </ThreatDetail>
        <div v-if="ocrConservationThreatHistoryId">
            <ConservationThreatHistory ref="ocr_conservation_threat_history" :key="ocrConservationThreatHistoryId"
    ...
    methods: {
        ...
        discardThreat: function (id) {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch(helpers.add_endpoint_json(api_endpoints.ocr_threat, id + '/discard'), {
                        method: 'PATCH',
        ...
        reinstateThreat: function (id) {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch(helpers.add_endpoint_json(api_endpoints.ocr_threat, id + '/reinstate'), {
                        method: 'PATCH',
                        headers: { 'Content-Type': 'application/json', }
                    })
                        .then((response) => {

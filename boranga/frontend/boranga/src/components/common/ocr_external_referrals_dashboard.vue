<template id="ocr_external_referrals_dashboard">
    <div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="ocr_ref_scientific_name_lookup">Scientific Name:</label>
                        <select id="ocr_ref_scientific_name_lookup" name="ocr_ref_scientific_name_lookup"
                            ref="ocr_ref_scientific_name_lookup" class="form-control" />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
        ...
        <div class="row">
            <div class="col-lg-12">
                <datatable ref="flora_ocr_ref_datatable" :id="datatable_id" :dtOptions="datatable_options"
...
export default {
    ...
    data() {
        let vm = this;
        return {
            datatable_id: 'ocr_external_ref-datatable-' + vm._uid,
    ...
    watch: {
        filterCSRefFloraScientificName: function () {
            let vm = this;
            vm.$refs.flora_ocr_ref_datatable.vmDataTable.ajax.reload(helpers.enablePopovers, false); // This calls ajax() backend call.
    ...
    methods: {
        ...
        initialiseScientificNameLookup: function () {
            let vm = this;
            $(vm.$refs.ocr_ref_scientific_name_lookup).select2({
                ...
                on("select2:open", function (e) {
                    const searchField = $('[aria-controls="select2-ocr_ref_scientific_name_lookup-results"]')
        ...
        addEventListeners: function () {
            let vm = this;
            vm.$refs.flora_ocr_ref_datatable.vmDataTable.on('childRow.dt', function (e, settings) {
                helpers.enablePopovers();
            });
        },
    },

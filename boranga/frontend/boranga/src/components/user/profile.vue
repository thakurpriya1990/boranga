                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body collapse" :id="oBody">
                      <form class="form-horizontal" name="orgForm" method="post">
                          ...
                          <div v-for="org in profile.boranga_organisations">
                              <div class="form-group">
...
export default {
    ...
    computed: {
        ...
        hasOrgs: function() {
            return this.profile.boranga_organisations && this.profile.boranga_organisations.length > 0 ? true: false;
        },
    ...
    methods: {
            ...
            vm.$http.post(helpers.add_endpoint_json(api_endpoints.organisations,(vm.newOrg.id+'/validate_pins')),JSON.stringify(this.newOrg),{
                ...
                if (response.body.valid){
                    ...
                    Vue.http.get(api_endpoints.profile).then((response) => {
                        vm.profile = response.body
                        if (vm.profile.residential_address == null){ vm.profile.residential_address = {}; }
                        if ( vm.profile.boranga_organisations && vm.profile.boranga_organisations.length > 0 ) { vm.managesOrg = 'Yes' }
                    },(error) => {
                        console.log(error);
                    })
                }else {
        ...
        orgConsultRequest: function() {
            ...
            for (var organisation in vm.profile.boranga_organisations) {
                if (new_organisation.abn && vm.profile.boranga_organisations[organisation].abn == new_organisation.abn) {
                    swal({

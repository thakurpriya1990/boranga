<template id="external_conservation_status_datatable">
    <div>
        ...
        <div v-if="addCSVisibility" class="col-md-12 dropdown">
            <div class="text-end">
                <button class="btn btn-primary dropdown-toggle mb-2" type="button" id="cs_proposal_type"
        ...
        <div class="row">
            <div class="col-lg-12">
                <datatable ref="conservation_status_datatable" :id="datatable_id" :dtOptions="datatable_options"

            ...
            <div class="col-sm-12">
                <div class="row">
                    <div v-if="isOCRProposal" class="col-sm-offset-3 col-sm-6 borderDecoration">
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><strong> {{ formatDate(occurrence_report_obj.lodgement_date) }}</strong></td>
                                </tr>
                            </tbody>
                        </table>
                        <br />
                        ...
                        <router-link :to="{ name: 'external-occurrence-report-dash' }" style="margin-top:15px;"
                    ...
                    <div v-else class="col-sm-offset-3 col-sm-6 borderDecoration">
                        ...
                        <br /><router-link :to="{ name: 'external-occurrence-report-dash' }" style="margin-top:15px;"
                            class="btn btn-primary">Back to home</router-link>
                    </div>
                </div>
            </div>

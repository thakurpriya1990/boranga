    ...
    computed: {
            ...
            return {
                ...
                render: function (row, type, full) {
                    if (full.data.communitydocument.fields.document_number) {
                        return (
                            full.data.communitydocument.fields.document_number +
                            '-' +
                        ...
                        return (
                            'D' +
                            full.data.communitydocument.pk +
                            '-' +
                            full.revision_sequence
                        );
                    }
            ...
            return {
                ...
                render: function (row, type, full) {
                    if (full.data.communitydocument.fields.document_category) {
                        return full.data.communitydocument.fields
        ...
        column_sub_category: function () {
            return {
                ...
                render: function (row, type, full) {
                    if (
                        full.data.communitydocument.fields.document_sub_category
                    ) {
                        return full.data.communitydocument.fields
                ...
                mRender: function (row, type, full) {
                    ...
                    if (full.data.communitydocument.fields.active) {
                        ...
                        links +=
                            ...
                            full.data.communitydocument.fields._file +
                            '" target="_blank">' +
                            result.text +
                            '</a> ' +
                            result.link +
        ...
        datatable_options: function () {
            ...
            return {
                ...
                ajax: {
                    url:
                        api_endpoints.lookup_history_community_document(
                            this.documentId
                        ) + '?format=datatables',
                    dataSrc: 'data',
                },

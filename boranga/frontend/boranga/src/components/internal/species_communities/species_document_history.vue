    ...
    computed: {
            ...
            return {
                ...
                render: function (row, type, full) {
                    if (full.data.speciesdocument.fields.document_number) {
                        return (
                            full.data.speciesdocument.fields.document_number +
                            '-' +
            ...
            return {
                ...
                render: function (row, type, full) {
                    if (full.data.speciesdocument.fields.document_category) {
                        return full.data.speciesdocument.fields
        ...
        column_sub_category: function () {
            return {
                ...
                render: function (row, type, full) {
                    if (
                        full.data.speciesdocument.fields.document_sub_category
                    ) {
                        return full.data.speciesdocument.fields
        ...
        datatable_options: function () {
            ...
            return {
                ...
                ajax: {
                    url:
                        api_endpoints.lookup_history_species_document(
                            this.documentId
                        ) + '?format=datatables',
                    dataSrc: 'data',
                },

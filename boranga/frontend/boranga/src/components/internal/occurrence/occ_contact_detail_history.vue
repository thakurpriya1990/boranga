    ...
    computed: {
        ...
        column_sequence: function () {
            return {
                ...
                visible: true,
                render: function (row, type, full) {
                    if (full.data.occcontactdetail.fields.site_number) {
                        return full.data.occcontactdetail.fields.site_number+'-'+full.revision_sequence;
                    } else {
                        return "ST"+full.data.occcontactdetail.pk+'-'+full.revision_sequence;
                    }
                },
        ...
        column_number: function () {
            return {
                // 2. Number
                data: 'data.data.occcontactdetail.fields.site_number',
                defaultContent: '',
                orderable: false,
                searchable: false, 
                visible: true,

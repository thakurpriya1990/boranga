    ...
    computed: {
            ...
            return {
                ...
                render: function (row, type, full) {
                    if (full.data.ocrconservationthreat.fields.threat_number) {
                        return (
                            full.data.ocrconservationthreat.fields
                                .threat_number +
                            '-' +
                        ...
                        return (
                            'T' +
                            full.data.ocrconservationthreat.pk +
                            '-' +
                            full.revision_sequence
                        );
                    }
        ...
        column_number: function () {
            return {
                ...
                render: function (row, type, full) {
                    return (
                        full.data.ocrconservationthreat.fields.threat_number +
                        '-' +
                        full.revision_sequence
                    );
                },
        ...
        column_category: function () {
            return {
                ...
                render: function (row, type, full) {
                    if (
                        full.data.ocrconservationthreat.fields.threat_category
                    ) {
                        return full.data.ocrconservationthreat.fields
        ...
        datatable_options: function () {
            ...
            return {
                ...
                ajax: {
                    url:
                        api_endpoints.lookup_history_ocr_conservation_threat(
                            this.threatId
                        ) + '?format=datatables',
                    dataSrc: 'data',
                },

                            ...
                            <div class="row">
                                <div v-if="threatId" class="col-lg-12">
                                    ...
                                    <DisplayHistory
                                        ...
                                        :primary_model="'OcrConservationThreat'"
                                    />
                                    </div>
                                </div>
                            </div>
...
export default {
    name: 'OcrConservationThreatHistory',
    components: {
        modal,
        alert,
        datatable,
    ...
    computed: {
        ...
        column_data: function () {
            return {
                ...
                render: function (row, type, full) {
                    return full.data.data.ocrconservationthreat;
                },
                name: 'data',
            };
        },
        column_sequence: function () {
            return {
                ...
                visible: true,
                render: function (row, type, full) {
                    if (full.data.ocrconservationthreat.fields.threat_number) {
                        return full.data.ocrconservationthreat.fields.threat_number+'-'+full.revision_sequence;
                    } else {
                        return "T"+full.data.ocrconservationthreat.pk+'-'+full.revision_sequence;
                    }
                },
        ...
        column_id: function () {
            return {
                // 1. ID
                data: 'data.data.ocrconservationthreat.pk',
                orderable: false,
                searchable: false,
                visible: false,
                render: function (row, type, full) {
                    return full.data.ocrconservationthreat.pk;
                },
                name: 'id',
            };
        },
        column_number: function () {
            return {
                // 2. Number
                data: 'data.data.ocrconservationthreat.fields.threat_number',
                defaultContent: '',
                orderable: false,
                searchable: false, 
                visible: true,
        ...
        column_category: function () {
            return {
                ...
                visible: true,
                render: function (row, type, full) {
                    if(full.data.ocrconservationthreat.fields.threat_category) {
                        return full.data.ocrconservationthreat.fields.threat_category.name;
                    } else {
                        return ''
                    }
                },
        ...
        column_comment: function () {
            return {
                // 4. Description
                data: 'data.data.ocrconservationthreat.fields.comment',
                defaultContent: '',
                orderable: false,
                searchable: true, 
                visible: true,
                render: function (row, type, full) {
                    let value = full.data.ocrconservationthreat.fields.description;
        ...
        datatable_options: function () {
            ...
            return {
                ...
                serverSide: true,
                ajax: {
                    url: api_endpoints.lookup_history_ocr_conservation_threat(this.threatId)+"?format=datatables",
                    dataSrc: 'data',
                },
                buttons: [
                    {

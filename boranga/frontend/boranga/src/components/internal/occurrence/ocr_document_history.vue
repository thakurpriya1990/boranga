<template lang="html">
    <div id="occurrenceReportDocumentHistory">
        <modal
            ...
            :title="'Occurrence Report OCR'+ occurrenceReportId +' - Document D' + documentId + ' - History ' "
            :large="true"
            :full="true"
            :showOK="false"
            cancel-text="Close"
                            ...
                            <div class="row">
                                <div v-if="documentId" class="col-lg-12">
                                    ...
                                    <DisplayHistory
                                        ...
                                        :primary_model="'OccurrenceReportDocument'"
                                    />
                                    </div>
                                </div>
                            </div>
...
export default {
    name: 'OccurrenceReportDocumentHistory',
    components: {
        modal,
        alert,
        datatable,
    ...
    computed: {
        ...
        column_data: function () {
            return {
                ...
                render: function (row, type, full) {
                    return full.data.data.occurrencereportdocument;
                },
                name: 'data',
            };
        },
        column_sequence: function () {
            return {
                ...
                visible: true,
                render: function (row, type, full) {
                    if (full.data.occurrencereportdocument.fields.document_number) {
                        return full.data.occurrencereportdocument.fields.document_number+'-'+full.revision_sequence;
                    } else {
                        return "D"+full.data.occurrencereportdocument.pk+'-'+full.revision_sequence;
                    }
                },
        ...
        column_id: function () {
            return {
                // 1. ID
                data: 'data.data.occurrencereportdocument.pk',
                orderable: false,
                searchable: false,
                visible: false,
                render: function (row, type, full) {
                    return full.data.occurrencereportdocument.pk;
                },
                name: 'id',
            };
        },
            ...
            return {
                ...
                render: function (row, type, full) {
                    if(full.data.occurrencereportdocument.fields.document_category) {
                        return full.data.occurrencereportdocument.fields.document_category.document_category_name;
                    } else {
                        return ''
                    }
                },
            ...
            return {
                ...
                render: function (row, type, full) {
                    if(full.data.occurrencereportdocument.fields.document_sub_category) {
                        return full.data.occurrencereportdocument.fields.document_sub_category.document_sub_category_name;
                    } else {
                        return ''
                    }
                },
        ...
        datatable_options: function () {
            ...
            return {
                ...
                serverSide: true,
                ajax: {
                    url: api_endpoints.lookup_history_occurrence_report_document(this.documentId)+"?format=datatables",
                    dataSrc: 'data',
                },
                buttons: [
                    {

    ...
    computed: {
        ...
        column_sequence: function () {
            return {
                ...
                render: function (row, type, full) {
                    if (
                        full.data.occurrencereportdocument.fields
                            .document_number
                    ) {
                        return (
                            full.data.occurrencereportdocument.fields
                        ...
                        return (
                            'D' +
                            full.data.occurrencereportdocument.pk +
                            '-' +
                            full.revision_sequence
                        );
                    }
            ...
            return {
                ...
                render: function (row, type, full) {
                    if (
                        ...
                        return full.data.occurrencereportdocument.fields
            ...
            return {
                ...
                mRender: function (row, type, full) {
                    ...
                    if (full.data.occurrencereportdocument.fields.active) {
                        let value =
                            full.data.occurrencereportdocument.fields.name;
                        let result = helpers.dtPopoverSplit(value, 30, 'hover');
                        links +=
                            '<span><a href="/private-media/' +
                            full.data.occurrencereportdocument.fields._file +
                            '" target="_blank">' +
                            result.text +
                            '</a> ' +
                            result.link +
        ...
        column_description: function () {
            return {
                ...
                render: function (row, type, full) {
                    let value =
                        full.data.occurrencereportdocument.fields.description;
                    let result = helpers.dtPopover(value, 30, 'hover');
        ...
        datatable_options: function () {
            ...
            return {
                ...
                ajax: {
                    url:
                        api_endpoints.lookup_history_occurrence_report_document(
                            this.documentId
                        ) + '?format=datatables',
                    dataSrc: 'data',
                },

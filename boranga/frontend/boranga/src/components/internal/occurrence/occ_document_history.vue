<template lang="html">
    <div id="occurrenceDocumentHistory">
        <modal
            ...
            :title="'Occurrence  OCC'+ occurrenceId +' - Document D' + documentId + ' - History ' "
            :large="true"
            :full="true"
            :showOK="false"
            cancel-text="Close"
    ...
    computed: {
            ...
            return {
                ...
                render: function (row, type, full) {
                    if (full.data.occurrencedocument.fields.document_number) {
                        ...
                        return "D"+full.data.occurrencedocument.pk+'-'+full.revision_sequence;
                    }
                },
            ...
            return {
                ...
                render: function (row, type, full) {
                    if(full.data.occurrencedocument.fields.document_category) {
                        return full.data.occurrencedocument.fields.document_category.document_category_name;
                    } else {
                        return ''
                    }
                },
            ...
            return {
                ...
                render: function (row, type, full) {
                    if(full.data.occurrencedocument.fields.document_sub_category) {
                        return full.data.occurrencedocument.fields.document_sub_category.document_sub_category_name;
                    } else {
                        return ''
                    }
                },
        ...
        column_file: function () {
            return {
                ...
                mRender: function (row, type, full) {
                    let links='';
                    if(full.data.occurrencedocument.fields.visible){
                        let name = full.data.occurrencedocument.fields.name;
                        if (name.length > 30)
                        {
                            name = name.substring(0, 27) + "...";
                        }
                        links+='<a href="/private-media/'+ full.data.occurrencedocument.fields._file+'" target="_blank"><p>' + name + '</p></a>' ;
                    }else{
        ...
        datatable_options: function () {
            ...
            return {
                ...
                serverSide: true,
                ajax: {
                    url: api_endpoints.lookup_history_occurrence_document(this.documentId)+"?format=datatables",
                    dataSrc: 'data',
                },
                buttons: [
                    {

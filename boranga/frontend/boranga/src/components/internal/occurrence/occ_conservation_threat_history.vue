    ...
    computed: {
            ...
            return {
                ...
                render: function (row, type, full) {
                    if (full.data.occconservationthreat.fields.threat_number) {
                        return (
                            full.data.occconservationthreat.fields
                                .threat_number +
                            '-' +
                        ...
                        return (
                            'T' +
                            full.data.occconservationthreat.pk +
                            '-' +
                            full.revision_sequence
                        );
                    }
        ...
        column_number: function () {
            return {
                ...
                render: function (row, type, full) {
                    return (
                        full.data.occconservationthreat.fields.threat_number +
                        '-' +
                        full.revision_sequence
                    );
                },
        ...
        column_category: function () {
            return {
                ...
                render: function (row, type, full) {
                    if (
                        full.data.occconservationthreat.fields.threat_category
                    ) {
                        return full.data.occconservationthreat.fields
        ...
        datatable_options: function () {
            ...
            return {
                ...
                ajax: {
                    url:
                        api_endpoints.lookup_history_occ_conservation_threat(
                            this.threatId
                        ) + '?format=datatables',
                    dataSrc: 'data',
                },

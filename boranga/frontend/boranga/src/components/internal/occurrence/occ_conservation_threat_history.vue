<template lang="html">
    <div id="occConservationThreatHistory">
        <modal
            transition="modal fade"
            :title="'OCC Conservation Threat T' + threatId + ' - History ' "
            :large="true"
            :full="true"
            :showOK="false"
            cancel-text="Close"
...
export default {
    name: 'OCCConservationThreatHistory',
    components: {
        modal,
        alert,
        datatable,
    ...
    computed: {
        ...
        column_data: function () {
            return {
                ...
                render: function (row, type, full) {
                    return full.data.data.occconservationthreat;
                },
                name: 'data',
            };
        },
        column_sequence: function () {
            return {
                ...
                visible: true,
                render: function (row, type, full) {
                    if (full.data.occconservationthreat.fields.threat_number) {
                        return full.data.occconservationthreat.fields.threat_number+'-'+full.revision_sequence;
                    } else {
                        return "T"+full.data.occconservationthreat.pk+'-'+full.revision_sequence;
                    }
                },
        ...
        column_id: function () {
            return {
                // 1. ID
                data: 'data.data.occconservationthreat.pk',
                orderable: false,
                searchable: false,
                visible: false,
                render: function (row, type, full) {
                    return full.data.occconservationthreat.pk;
                },
                name: 'id',
            };
        },
        column_number: function () {
            return {
                // 2. Number
                data: 'data.data.occconservationthreat.fields.threat_number',
                defaultContent: '',
                orderable: false,
                searchable: false,
                visible: true,
        ...
        column_category: function () {
            return {
                data: 'data.data.occconservationthreat.fields.threat_category',
                defaultContent: '',
                orderable: false,
                searchable: false,
                visible: true,
                render: function (row, type, full) {
                    if(full.data.occconservationthreat.fields.threat_category) {
                        return full.data.occconservationthreat.fields.threat_category.name;
                    } else {
                        return ''
                    }
                },
        ...
        column_comment: function () {
            return {
                // 4. Description
                data: 'data.data.occconservationthreat.fields.comment',
                defaultContent: '',
                orderable: false,
                searchable: true,
                visible: true,
        ...
        datatable_options: function () {
            ...
            return {
                ...
                serverSide: true,
                ajax: {
                    url: api_endpoints.lookup_history_occ_conservation_threat(this.threatId)+"?format=datatables",
                    dataSrc: 'data',
                },
                buttons: [
                    {
                        extend: 'excel',
                        title: 'Boranga OCC Conservation Threat History Excel Export',
                    ...
                    {
                        extend: 'csv',
                        title: 'Boranga OCC Conservation Threat History CSV Export',
